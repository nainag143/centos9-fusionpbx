...
#sudo dnf groupinstall -y "Development Tools" sudo dnf install -y \ git \  python3 \ python3-devel \ autoconf \ automake \ cmake \ libtool \ ncurses-compat-libs \ ncurses-devel \ make \ libjpeg-turbo-devel \ pkgconf-pkg-config \ zlib-devel \ sqlite \ sqlite-devel \ pcre-devel \ speexdsp-devel \ libedit-devel \ ldns-devel \ lua-devel \ libcurl-devel \ apr-devel \ yasm \ sndfile-devel \ opus-devel \ libtiff-devel \ ffmpeg-devel \ postgresql-devel
